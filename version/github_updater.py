...
def find_asset_download_url(release_data: dict, asset_name: str):
...
def check_and_update(parent=None):
    try:
        ...
        download_url = find_asset_download_url(release_data, ASSET_NAME)
        if not download_url:
        ...
        download_file(download_url, new_exe_path)
